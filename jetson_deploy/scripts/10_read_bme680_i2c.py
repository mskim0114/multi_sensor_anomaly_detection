...
def print_troubleshooting_i2c() -> None:
    ...
    print("  4. Pin 3 (SDA) / Pin 5 (SCL) carry 3.3V 2.2k pull-ups on the Orin Nano", file=sys.stderr)
    print("     Developer Kit carrier board, so a module works on this bus alone.", file=sys.stderr)
